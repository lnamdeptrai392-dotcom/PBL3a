...
('T002','teacher2','123456','Nguyen Van B','0900000004','1985-05-05','Male','Teacher'),
('T003','teacher3','123456','Nguyen Van C','0900000004','1985-05-05','Male','Teacher'),
-- ================= NỮ (MÃ 101) =================
-- Khóa 2009
...
VALUES
-- ================= TOÁN (Txx) =================
(N'T10.0125', N'Lớp Toán 10A1', 'T10', 'T001', '2025-01-01', '2025-06-01', 30),
(N'T10.0426', N'Lớp Toán 10A2', 'T10', 'T001', '2026-04-01', '2026-09-01', 30),
(N'T10.0726', N'Lớp Toán 10A3', 'T10', 'T001', '2026-07-01', '2026-12-01', 30),
(N'T10.0926', N'Lớp Toán 10B1', 'T10', 'T001', '2026-09-01', '2027-02-01', 25),
(N'T11.0825', N'Lớp Toán 11A1', 'T11', 'T001', '2025-08-01', '2025-12-01', 35),
(N'T12.0126', N'Lớp Toán 12A1', 'T12', 'T001', '2026-01-01', '2026-06-01', 30),

-- ================= VĂN (Vxx) =================
(N'V10.0225', N'Lớp Văn 10A1', 'V10', 'T001', '2025-02-01', '2025-07-01', 35),
(N'V10.1026', N'Lớp Văn 10B1', 'V10', 'T001', '2026-10-01', '2027-03-01', 25),
(N'V11.0925', N'Lớp Văn 11A1', 'V11', 'T001', '2025-09-01', '2026-02-01', 30),
(N'V12.0326', N'Lớp Văn 12A1', 'V12', 'T001', '2026-03-01', '2026-08-01', 30),

-- ================= HÓA (Hxx) =================
(N'H10.0325', N'Lớp Hóa 10A1', 'H10', 'T001', '2025-03-01', '2025-08-01', 25),
(N'H10.1126', N'Lớp Hóa 10B1', 'H10', 'T002', '2026-11-01', '2027-04-01', 25),
(N'H11.1025', N'Lớp Hóa 11A1', 'H11', 'T001', '2025-10-01', '2026-03-01', 30),
(N'H12.0426', N'Lớp Hóa 12A1', 'H12', 'T001', '2026-04-01', '2026-09-01', 30),

-- ================= LÝ (Lxx) =================
(N'L10.0425', N'Lớp Lý 10A1', 'L10', 'T001', '2025-04-01', '2025-09-01', 30),
(N'L10.1226', N'Lớp Lý 10B1', 'L10', 'T001', '2026-12-01', '2027-05-01', 25),
(N'L11.0526', N'Lớp Lý 11A1', 'L11', 'T001', '2026-05-01', '2026-10-01', 25),
(N'L11.1125', N'Lớp Lý 11A2', 'L11', 'T001', '2025-11-01', '2026-04-01', 25),
(N'L12.0626', N'Lớp Lý 12A1', 'L12', 'T001', '2026-06-01', '2026-11-01', 30),

-- ================= SINH (Sxx) =================
(N'S10.0525', N'Lớp Sinh 10A1', 'S10', 'T001', '2025-05-01', '2025-10-01', 25),
(N'S11.1225', N'Lớp Sinh 11A1', 'S11', 'T001', '2025-12-01', '2026-04-10', 30),
(N'S12.0726', N'Lớp Sinh 12A1', 'S12', 'T001', '2026-07-01', '2026-12-01', 30),

-- ================= TIẾNG ANH (NN01) =================
(N'NN01.09.0226', N'Lớp Tiếng Anh 9A1','NN01.09', 'T001', '2026-02-01', '2026-07-01', 35),
(N'NN01.10.0125', N'Lớp Tiếng Anh 10A1', 'NN01.10', 'T001', '2025-01-01', '2025-06-01', 35),
(N'NN01.11.0526', N'Lớp Tiếng Anh 11A1', 'NN01.11', 'T001', '2026-05-01', '2026-10-01', 35),
(N'NN01.11.0626', N'Lớp Tiếng Anh 11A2', 'NN01.11', 'T001', '2026-06-01', '2026-11-01', 35),
(N'NN01.I.0625', N'Lớp Tiếng Anh IELTS 1', 'NN01.I', 'T001', '2025-06-01', '2025-11-01', 20),
(N'NN01.G.0826', N'Lớp Tiếng Anh Giao Tiếp 1', 'NN01.G', 'T001', '2026-08-01', '2027-01-01', 25),

-- ================= TIẾNG NHẬT (NN02) =================
(N'NN02.N5.0225', N'Lớp Tiếng Nhật N5 A1', 'NN02.N5', 'T001', '2025-02-01', '2025-07-01', 25),
(N'NN02.N5.0326', N'Lớp Tiếng Nhật N5 A2', 'NN02.N5', 'T001', '2026-03-01', '2026-08-01', 25),
(N'NN02.N4.0725', N'Lớp Tiếng Nhật N4 A1', 'NN02.N4', 'T001', '2025-07-01', '2025-12-01', 20),
(N'NN02.N3.0926', N'Lớp Tiếng Nhật N3 A1', 'NN02.N3', 'T001', '2026-09-01', '2027-02-01', 20),

-- ================= TIẾNG TRUNG (NN03) =================
(N'NN03.H1.0325', N'Lớp Tiếng Trung HSK1 A1', 'NN03.H1', 'T001', '2025-03-01', '2025-08-01', 30),
(N'NN03.H2.0825', N'Lớp Tiếng Trung HSK2 A1', 'NN03.H2', 'T001', '2025-08-01', '2026-01-01', 25),
(N'NN03.H3.0426', N'Lớp Tiếng Trung HSK3 A1', 'NN03.H3', 'T001', '2026-04-01', '2026-09-01', 25),
(N'NN03.G.1026', N'Lớp Tiếng Trung Giao Tiếp 1', 'NN03.G', 'T001', '2026-10-01', '2027-03-01', 30);
GO
...
VALUES
('10109001', 'T10.0426', '2026-03-10', N'Có mặt', N''),
('10109002', 'T10.0426', '2026-03-10', N'Vắng', N'Nghỉ có phép'),
('10209001', 'V10.0225', '2026-03-10', N'Muộn', N'Đến trễ 10 phút'),
('10109001', 'NN01.09.0226', '2026-03-10', N'Có mặt', N'');
GO
...
VALUES
('10109001', 'T10.0426', 3, 2026, 500000, N'Đã đóng', '2026-03-05', N'Đóng đủ'),
('10109002', 'T10.0426', 3, 2026, 500000, N'Chưa đóng', NULL, NULL),
('10209001', 'V10.0225', 3, 2026, 600000, N'Đã đóng', '2026-03-07', N''),
('10109001', 'NN01.09.0226', 3, 2026, 550000, N'Chưa đóng', NULL, N'');
GO
...
('T002', 4, 2026, 3, 20, 8000000, 500000, 0, 8500000, N'Chưa thanh toán', NULL, N'Lương tháng 4'),
('T003', 5, 2026, 3, 20, 8000000, 500000, 0, 8500000, N'Chưa thanh toán', NULL, N'Lương tháng 5');
GO
-- Khoản Thu
...
VALUES
-- ================= TOÁN (Txx) =================
-- T10.0426 (Lớp Toán 10A1) - 2 sessions per week
('T10.0426', 2, '07:30:00', '09:30:00'),  -- Tuesday morning
('T10.0426', 4, '07:30:00', '09:30:00'),  -- Thursday morning
-- T10.0726 (Lớp Toán 10A2)
('T10.0726', 2, '13:00:00', '15:00:00'),  -- Tuesday afternoon
('T10.0726', 5, '13:00:00', '15:00:00'),  -- Friday afternoon
-- T10.0125 (Lớp Toán 10A3)
('T10.0125', 1, '07:30:00', '09:30:00'),  -- Monday morning
('T10.0125', 3, '07:30:00', '09:30:00'),  -- Wednesday morning
-- T10.0926 (Lớp Toán 10B1)
('T10.0926', 2, '15:15:00', '17:15:00'),  -- Tuesday late afternoon
('T10.0926', 6, '08:00:00', '10:00:00'),  -- Saturday morning

-- T11.0825 (Lớp Toán 11A1)
('T11.0825', 3, '09:45:00', '11:45:00'),  -- Wednesday late morning
('T11.0825', 5, '09:45:00', '11:45:00'),  -- Friday late morning

-- T12.0126 (Lớp Toán 12A1)
('T12.0126', 1, '13:00:00', '15:00:00'),  -- Monday afternoon
('T12.0126', 4, '13:00:00', '15:00:00'),  -- Thursday afternoon



-- ================= VĂN (Vxx) =================
-- V10.0225 (Lớp Văn 10A1)
('V10.0225', 1, '09:45:00', '11:45:00'),  -- Monday late morning
('V10.0225', 3, '09:45:00', '11:45:00'),  -- Wednesday late morning
-- V10.1026 (Lớp Văn 10B1)
('V10.1026', 1, '15:15:00', '17:15:00'),  -- Monday late afternoon
('V10.1026', 3, '15:15:00', '17:15:00'),  -- Wednesday late afternoon

-- V11.0925 (Lớp Văn 11A1)
('V11.0925', 2, '07:30:00', '09:30:00'),  -- Tuesday morning
('V11.0925', 5, '07:30:00', '09:30:00'),  -- Friday morning

-- V12.0326 (Lớp Văn 12A1)
('V12.0326', 4, '13:00:00', '15:00:00'),  -- Thursday afternoon
('V12.0326', 6, '10:15:00', '12:15:00'),  -- Saturday late morning



-- ================= HÓA (Hxx) =================
-- H10.0325 (Lớp Hóa 10A1)
('H10.0325', 2, '09:45:00', '11:45:00'),  -- Tuesday late morning
('H10.0325', 4, '09:45:00', '11:45:00'),  -- Thursday late morning
-- H10.1126 (Lớp Hóa 10B1)
('H10.1126', 2, '15:15:00', '17:15:00'),  -- Tuesday late afternoon
('H10.1126', 6, '13:00:00', '15:00:00'),  -- Saturday afternoon

-- H11.1025 (Lớp Hóa 11A1)
('H11.1025', 1, '07:30:00', '09:30:00'),  -- Monday morning
('H11.1025', 3, '07:30:00', '09:30:00'),  -- Wednesday morning

-- H12.0426 (Lớp Hóa 12A1)
('H12.0426', 3, '13:00:00', '15:00:00'),  -- Wednesday afternoon
('H12.0426', 5, '13:00:00', '15:00:00'),  -- Friday afternoon



-- ================= LÝ (Lxx) =================
-- L10.0425 (Lớp Lý 10A1)
('L10.0425', 4, '07:30:00', '09:30:00'),  -- Thursday morning
('L10.0425', 6, '07:30:00', '09:30:00'),  -- Saturday morning
-- L10.1226 (Lớp Lý 10B1)
('L10.1226', 1, '13:00:00', '15:00:00'),  -- Monday afternoon
('L10.1226', 6, '15:15:00', '17:15:00'),  -- Saturday late afternoon

-- L11.0526 (Lớp Lý 11A1)
('L11.0526', 1, '09:45:00', '11:45:00'),  -- Monday late morning
('L11.0526', 5, '09:45:00', '11:45:00'),  -- Friday late morning
-- L11.1125 (Lớp Lý 11A2)
('L11.1125', 2, '13:00:00', '15:00:00'),  -- Tuesday afternoon
('L11.1125', 4, '13:00:00', '15:00:00'),  -- Thursday afternoon

-- L12.0626 (Lớp Lý 12A1)
('L12.0626', 3, '15:15:00', '17:15:00'),  -- Wednesday late afternoon
('L12.0626', 5, '15:15:00', '17:15:00'),  -- Friday late afternoon



-- ================= SINH (Sxx) =================
-- S10.0525 (Lớp Sinh 10A1)
('S10.0525', 2, '09:45:00', '11:45:00'),  -- Tuesday late morning
('S10.0525', 5, '09:45:00', '11:45:00'),  -- Friday late morning

-- S11.1225 (Lớp Sinh 11A1)
('S11.1225', 3, '07:30:00', '09:30:00'),  -- Wednesday morning
('S11.1225', 6, '10:15:00', '12:15:00'),  -- Saturday late morning

-- S12.0726 (Lớp Sinh 12A1)
('S12.0726', 1, '15:15:00', '17:15:00'),  -- Monday late afternoon
('S12.0726', 4, '15:15:00', '17:15:00'),  -- Thursday late afternoon



-- ================= TIẾNG ANH (NN01) =================
-- NN01.09.0226 (Lớp Tiếng Anh 9A1)
('NN01.09.0226', 2, '17:30:00', '19:30:00'),  -- Tuesday evening
('NN01.09.0226', 4, '17:30:00', '19:30:00'),  -- Thursday evening

-- NN01.10.0125 (Lớp Tiếng Anh 10A1)
('NN01.10.0125', 1, '17:30:00', '19:30:00'),  -- Monday evening
('NN01.10.0125', 3, '17:30:00', '19:30:00'),  -- Wednesday evening

-- NN01.0526 (Lớp Tiếng Anh 11A1)
('NN01.11.0526', 3, '13:00:00', '15:00:00'),  -- Wednesday afternoon
('NN01.11.0526', 5, '13:00:00', '15:00:00'),  -- Friday afternoon


-- NN01.I.0625 (Lớp Tiếng Anh IELTS 1)
('NN01.I.0625', 6, '13:00:00', '15:00:00'),  -- Saturday afternoon
('NN01.I.0625', 7, '13:00:00', '15:00:00'),  -- Sunday afternoon

-- NN01.0826 (Lớp Tiếng Anh Giao Tiếp 1)
('NN01.G.0826', 1, '19:45:00', '21:45:00'),  -- Monday evening
('NN01.G.0826', 3, '19:45:00', '21:45:00'),  -- Wednesday evening


-- ================= TIẾNG NHẬT (NN02) =================
-- NN02.N5.0225 (Lớp Tiếng Nhật N5 A1)
('NN02.N5.0225', 4, '17:30:00', '19:30:00'),  -- Thursday evening
('NN02.N5.0225', 6, '08:00:00', '10:00:00'),  -- Saturday morning

-- NN02.N5.0326 (Lớp Tiếng Nhật N5 A2)
('NN02.N5.0326', 1, '19:45:00', '21:45:00'),  -- Monday evening
('NN02.N5.0326', 4, '19:45:00', '21:45:00'),  -- Thursday evening

-- NN02.N4.0725 (Lớp Tiếng Nhật N4 A1)
('NN02.N4.0725', 2, '17:30:00', '19:30:00'),  -- Tuesday evening
('NN02.N4.0725', 5, '17:30:00', '19:30:00'),  -- Friday evening

-- NN02.N3.0926 (Lớp Tiếng Nhật N3 A1)
('NN02.N3.0926', 3, '17:30:00', '19:30:00'),  -- Wednesday evening
('NN02.N3.0926', 6, '10:15:00', '12:15:00'),  -- Saturday late morning


-- ================= TIẾNG TRUNG (NN03) =================
-- NN03.H1.0325 (Lớp Tiếng Trung HSK1 A1)
('NN03.H1.0325', 2, '19:45:00', '21:45:00'),  -- Tuesday evening
('NN03.H1.0325', 5, '19:45:00', '21:45:00'),  -- Friday evening

-- NN03.H2.0825 (Lớp Tiếng Trung HSK2 A1)
('NN03.H2.0825', 3, '19:45:00', '21:45:00'),  -- Wednesday evening
('NN03.H2.0825', 6, '15:15:00', '17:15:00'),  -- Saturday late afternoon

-- NN03.H3.0426 (Lớp Tiếng Trung HSK3 A1)
('NN03.H3.0426', 1, '17:30:00', '19:30:00'),  -- Monday evening
('NN03.H3.0426', 4, '17:30:00', '19:30:00'),  -- Thursday evening

-- NN03.G.1026 (Lớp Tiếng Trung Giao Tiếp 1)
('NN03.G.1026', 2, '17:30:00', '19:30:00'),  -- Tuesday evening
('NN03.G.1026', 6, '13:00:00', '15:00:00');  -- Saturday afternoon
GO
...
VALUES
-- ================= KHÓA 2009 ( Lớp 11 ) =================
('10109003', 'T11.0825', '2026-03-20', N'Chờ duyệt', N'Đăng ký vào lớp Toán 11A1'),
('10209004', 'V11.0925', '2026-03-21', N'Chờ duyệt', N'Đăng ký vào lớp Văn 11A1'),
('10209005', 'NN01.I.0625', '2026-03-23', N'Chờ duyệt', N'Đăng ký vào lớp IELTS 1'),

-- ================= KHÓA 2010 ( Lớp 10 ) =================
('10110001', 'T10.0426', '2026-03-20', N'Chờ duyệt', N'Đăng ký vào lớp Toán 10A2'),
('10210002', 'L10.0425', '2026-03-21', N'Chờ duyệt', N'đăng ký vào lớp Lý 10A1'),
('10210006', 'NN02.N5.0225', '2026-03-25', N'Chờ duyệt', N'Đăng ký vào lớp Tiếng Nhật N5'),

-- ================= KHÓA 2011 ( Lớp 9 ) =================
('10111001', 'NN01.09.0226', '2026-03-22', N'Chờ duyệt', N'Đăng ký vào lớp Tiếng Anh 9A1'),
('10211002', 'T10.0926', '2026-03-23', N'Chờ duyệt', N'Đăng ký học hè lớp Toán 10B1'),
('10111004', 'NN03.H1.0325', '2026-03-24', N'Chờ duyệt', N'Đăng ký Tiếng Trung HSK1 cho người mới bắt đầu'),

-- ================= KHÓA 2012 ( Lớp 8 ) =================
('10112001', 'NN01.G.0826', '2026-03-20', N'Chờ duyệt', N'Đăng ký lớp Giao tiếp Tiếng Anh 1'),
('10212003', 'NN02.N5.0326', '2026-03-21', N'Chờ duyệt', N'Đăng ký lớp Tiếng Nhật N5 A2'),

-- ================= KHÓA 2013 ( Lớp 7 ) =================
('10113002', 'NN01.G.0826', '2026-03-22', N'Chờ duyệt', N'Đăng ký vào lớp Tiếng Anh Giao tiếp'),
('10213005', 'NN03.H1.0325', '2026-03-23', N'Chờ duyệt', N'Đăng ký vào lớp Tiếng Trung HSK1');
GO
